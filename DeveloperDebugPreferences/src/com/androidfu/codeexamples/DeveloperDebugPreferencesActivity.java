...
public class DeveloperDebugPreferencesActivity extends MainActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (developer_debug_override) {
             ...
             * to have developer_debug_override set to true without that shared
             * preference.
             */
    ...
    protected void onResume() {
        ...
        if (BuildConfig.DEBUG && developer_debug_override) {
             ...
             * the debug flag is set to true in app preferences.
             * 
             * The BuildConfig.DEBUG isn't necessary, but I like it as a
             * failsafe mechanism in case the default return for
             * developer_debug_override were mistakenly changed to true ;)
             */
